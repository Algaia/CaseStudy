...
export default function PickingPage({ tasks, products, onCompletePick }) {
  ...
  return <>
    ...
    <div className="pick-layout">
      ...
      {selectedTask && product ? <SectionCard title="Pick instructions" subtitle={`${selectedTask.id} - ${selectedTask.customer}`}>
        ...
        <div className="form-actions"><Button variant="secondary" icon="external">Report issue</Button><Button icon="check" onClick={complete}>Complete pick</Button></div>
